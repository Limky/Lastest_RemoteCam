...
public class SelfieZoneUtil {
	//TODO : url 수정
	public static final String URL_ZONE = "/remote/api/SelfieZone";

	public static void getZone(final ResponseListener<SelfieZoneDomain[]> listener) {
		Log.d("test","getZone (2)");
		String url = (Demo.MODE_TEST) ? "file:///android_asset/SelfieZone.json" : Demo.SERVER_URL + URL_ZONE + File.separator;
		getArray(url, SelfieZoneDomain[].class, listener);
	}
